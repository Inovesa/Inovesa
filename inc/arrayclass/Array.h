/* Array.h:  A high-performance multi-dimensional C++ array class
   ...
   Copyright (C) 2018 Patrik Schönfeldt, Karlsruhe Institute of Technology
...
public:
  ...
  array1() : _size(0), state(unallocated) {}
...
public:
  ...
  void Dimension(unsigned int nx0, unsigned int ny0, T *v0=nullptr) {
    nx=nx0;
    ny=ny0;
